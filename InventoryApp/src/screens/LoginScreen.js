...
export default function LoginScreen({ onLogin }) {
  ...
  const handleLogin = async () => {
    ...
    try {
      ...
      Alert.alert(
        "Login failed",
        err?.response?.data?.error || err.message || "Invalid username or PIN.",
      );
    } finally {
      setLoading(false);
    }
  ...
  /* Modal is rendered inline (not as a sub-component) so React keeps
     the TextInput mounted across re-renders and the keyboard stays open. */
      ...
      <View style={styles.modalOverlay}>
        <View style={styles.modalCard}>
          ...
          <Text style={styles.modalSub}>
            Enter the IP or URL of the backend server.
          </Text>
          <TextInput
            style={styles.input}
            value={serverIpInput}
            onChangeText={setServerIpInput}
            placeholder="e.g. 192.168.2.56 or localhost"
            autoCapitalize="none"
            keyboardType="url"
            autoCorrect={false}
            autoFocus
      ...
      >
        ...
        <View style={styles.card}>
          ...
          <Text style={styles.subtitle}>
            Cannot reach server at {currentIp}
          </Text>
          ...
          <View style={styles.roleToggleRow}>
            <TouchableOpacity
              style={[
                styles.roleToggle,
                offlineRole === "worker" && styles.roleToggleActive,
              ]}
            ...
            >
              <MaterialCommunityIcons
                ...
                size={16}
                color={offlineRole === "worker" ? "#fff" : Colors.textSecondary}
              />
              <Text
                style={[
                  styles.roleToggleText,
                  offlineRole === "worker" && styles.roleToggleTextActive,
                ]}
              >
                Worker
              </Text>
            ...
            <TouchableOpacity
              style={[
                styles.roleToggle,
                offlineRole === "admin" && styles.roleToggleActive,
              ]}
            ...
            >
              <MaterialCommunityIcons
                name="shield-account"
                size={16}
                color={offlineRole === "admin" ? "#fff" : Colors.textSecondary}
              />
              <Text
                style={[
                  styles.roleToggleText,
                  offlineRole === "admin" && styles.roleToggleTextActive,
                ]}
              >
                Admin
              </Text>
          ...
          <TouchableOpacity
            style={[
              styles.button,
              !offlineName.trim() && styles.buttonDisabled,
            ]}
